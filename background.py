    ...
    for c in cnts:
        ...
        if (w >= 100) and (h>=150):
            ...
            if (cx > 250) and (Flag == False):
                ...
                roi = frame[int(y_crop*(frame_h/copy_h)):int(y_crop*(frame_h/copy_h)+h_crop*(frame_h/copy_h)), int(x_crop*(frame_w/copy_w)):int(x_crop*(frame_w/copy_w)+w_crop*(frame_w/copy_w))]
